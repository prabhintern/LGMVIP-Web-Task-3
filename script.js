...
function data() {
  ...
  if (element[5].checked) {
    skills.innerHTML = "SKILLS: HTML and CSS";
  }
  if (element[6].checked) {
    skills.innerHTML = "SKILLS: ReactJS";
  }
  if (element[7].checked) {
    skills.innerHTML = "SKILLS: C++";
  }
  if (element[5].checked && element[6].checked) {
    skills.innerHTML = "SKILLS: HTML and CSS, ReactJS";
  }
  if (element[5].checked && element[7].checked) {
    skills.innerHTML = "SKILLS: HTML and CSS, C++";
  }
  if (element[6].checked && element[7].checked) {
    skills.innerHTML = "SKILLS: ReactJS, C++";
  }
  if (element[5].checked && element[6].checked && element[7].checked) {
    skills.innerHTML = "SKILLS: HTML and CSS, ReactJS, C++";
  }
